...
const PRODUCTS_DATA = [
  ...
  },
  {
    ...
    rating: 5.0,
    reviewsCount: 42,
    shortSpecs: ["Kit Completo $70.000", "Sincronizado $15.000", "Baofeng BF-888S UHF", "Incluye Base Carga + Audífonos"],
    description: "Kit completo de radiocomunicadores profesionales Baofeng BF-888S UHF (400-470MHz). Disponibles sin sincronizar o con servicio de sincronizado de línea única en una frecuencia fija por $15.000 adicionales. Incluye base de carga inteligente de escritorio, batería recargable de Li-ion de larga duración, antena de alta ganancia, clip de cinturón y audífonos manos libres con micrófono PTT.",
    features: [
